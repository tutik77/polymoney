...
def _column_exists(insp: sa.engine.reflection.Inspector, table: str, column: str) -> bool:
    try:
...
def _index_exists(insp: sa.engine.reflection.Inspector, table: str, index_name: str) -> bool:
    try:
