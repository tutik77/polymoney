...
def get_settings() -> Settings:
    return Settings(
        ...
        max_requests_per_second=float(os.getenv("MAX_REQUESTS_PER_SECOND", os.getenv("REQUESTS_PER_SECOND", "6"))),
        ...
        activities_poll_interval_seconds=float(os.getenv("ACTIVITIES_POLL_INTERVAL_SECONDS", "60")),
        activities_ts_grace_seconds=float(os.getenv("ACTIVITIES_TS_GRACE_SECONDS", "30")),
        activities_max_pages_per_poll=int(os.getenv("ACTIVITIES_MAX_PAGES_PER_POLL", "10")),
